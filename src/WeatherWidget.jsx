      ...
      return (
        <div id="widget">
          <div id="temp-conditions-wrapper">
            <div id="temp-wrapper">
              <div id="icon-wrapper">
                <img id="weather-icon" height="48" width="48" alt={weatherCodes[code].description} src={weatherCodes[code][is_day]} />
              </div>
            ...
            <div id="conditions-wrapper">
              ...
              <p>
                Feels like: <span>{tempUnit === "°C" ? celsiusFeel : fahrenheitFeel}{" "} {tempUnit}</span>
              </p>
          ...
          <div id="time-wrapper">
            ...
            <p className="smaller-text">
              * The source is updated every 15 minutes. Refresh to get the latest available data.
            </p>
          </div>
        </div>
      );
